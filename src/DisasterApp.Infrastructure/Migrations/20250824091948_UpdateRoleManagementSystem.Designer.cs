...
namespace DisasterApp.Infrastructure.Migrations
{
    ...
    [Migration("20250824091948_UpdateRoleManagementSystem")]
    partial class UpdateRoleManagementSystem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DisasterApp.Domain.Entities.AuditLog", b =>
                {
                    ...
                    b.HasIndex(new[] { "Action", "Timestamp" }, "IX_AuditLog_Action_Timestamp")
                        .IsDescending(false, true);

                    b.HasIndex(new[] { "EntityType", "Timestamp" }, "IX_AuditLog_EntityType_Timestamp")
                        .IsDescending(false, true);

                    b.HasIndex(new[] { "Resource", "Timestamp" }, "IX_AuditLog_Resource_Timestamp")
                        .IsDescending(false, true);

                    b.HasIndex(new[] { "UserName", "Action", "Timestamp" }, "IX_AuditLog_Search")
                        .IsDescending(false, false, true);

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex(new[] { "UserName", "Action", "Timestamp" }, "IX_AuditLog_Search"), new[] { "Details" });

                    b.HasIndex(new[] { "Severity", "Timestamp" }, "IX_AuditLog_Severity_Timestamp")
                        .IsDescending(false, true);

                    b.HasIndex(new[] { "Timestamp" }, "IX_AuditLog_Timestamp_DESC")
                        .IsDescending();

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex(new[] { "Timestamp" }, "IX_AuditLog_Timestamp_DESC"), new[] { "AuditLogId", "Action", "Severity", "Details", "UserId", "UserName", "IpAddress", "UserAgent", "Resource", "Metadata" });
